...
--
-- Run this script to set up the complete Archon database 
-- schema and initial data for self-hosted Supabase
-- =====================================================

-- =====================================================
-- SECTION 1: CORE ROLES AND SETUP
-- =====================================================

-- Create basic roles for self-hosted Supabase
DO $$
BEGIN
  -- Create supabase_admin role if it doesn't exist
  IF NOT EXISTS (SELECT FROM pg_roles WHERE rolname = 'supabase_admin') THEN
    CREATE ROLE supabase_admin WITH NOLOGIN;
  END IF;

  -- Create basic auth roles
...
GRANT ALL ON archon_settings TO supabase_admin;
GRANT SELECT, INSERT, UPDATE ON archon_settings TO authenticated;
GRANT SELECT ON archon_settings TO anon;

-- =====================================================
-- SECTION 4: INITIAL SETTINGS DATA
-- =====================================================
...
-- =====================================================
-- SECTION 5: KNOWLEDGE BASE TABLES
-- =====================================================
...
-- =====================================================
-- SECTION 6B: HYBRID SEARCH FUNCTIONS WITH TS_VECTOR
-- =====================================================
...
GRANT ALL ON archon_sources TO supabase_admin;
GRANT ALL ON archon_code_examples TO supabase_admin;

GRANT SELECT, INSERT, UPDATE, DELETE ON archon_crawled_pages TO authenticated;
GRANT SELECT, INSERT, UPDATE, DELETE ON archon_sources TO authenticated;
GRANT SELECT, INSERT, UPDATE, DELETE ON archon_code_examples TO authenticated;

GRANT SELECT ON archon_crawled_pages TO anon;
GRANT SELECT ON archon_sources TO anon;
GRANT SELECT ON archon_code_examples TO anon;
...
-- Grant permissions to roles
GRANT ALL ON archon_projects TO supabase_admin;
GRANT ALL ON archon_tasks TO supabase_admin;
GRANT ALL ON archon_project_sources TO supabase_admin;
GRANT ALL ON archon_document_versions TO supabase_admin;
GRANT ALL ON archon_prompts TO supabase_admin;

GRANT SELECT, INSERT, UPDATE, DELETE ON archon_projects TO authenticated;
GRANT SELECT, INSERT, UPDATE, DELETE ON archon_tasks TO authenticated;
GRANT SELECT, INSERT, UPDATE, DELETE ON archon_project_sources TO authenticated;
GRANT SELECT ON archon_document_versions TO authenticated;
GRANT SELECT ON archon_prompts TO authenticated;

GRANT SELECT ON archon_projects TO anon;
GRANT SELECT ON archon_tasks TO anon;
GRANT SELECT ON archon_project_sources TO anon;
GRANT SELECT ON archon_document_versions TO anon;
GRANT SELECT ON archon_prompts TO anon;
